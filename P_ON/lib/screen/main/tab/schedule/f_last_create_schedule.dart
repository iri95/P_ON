...
import 'package:p_on/screen/main/tab/promise_room/widget/w_checked_modal.dart';
import 'package:percent_indicator/linear_percent_indicator.dart';
import 'package:velocity_x/velocity_x.dart';
import 'dto_schedule.dart';

class LastCreateSchedule extends ConsumerStatefulWidget {
  const LastCreateSchedule({super.key});

  @override
  ConsumerState<LastCreateSchedule> createState() => _LastCreateScheduleState();
}

class _LastCreateScheduleState extends ConsumerState<LastCreateSchedule> {
