...
<table>
    <tr>
        ...
        <td height="140px" align="center"> <a href="https://github.com/iri95">
            <img src="/images/sh.png" width="140px" /> <br><br> 이상훈 🤹🏻‍♂️ <br>(BackEnd) </a> <br></td>
...
|   ![](/images/web.png)    | <img  align="center" src="/images/p-on.site.png" alt="메인" height="400"> |
| :-----------------------: | :-----------------------------------------------------------------------: |
| <b>서비스 소개 페이지</b> |                          <b>서비스 소개 전체</b>                          |
| ![](/images/미리보기.png) |                           ![](/images/faq.png)                            |
|  <b>미리보기 페이지</b>   |                             <b>FAQ 페이지</b>                             |

## 🌟 주요 기능

#### 🤙🏻 약속방

| ![](/images/약속생성.gif) | ![](/images/약속투표.gif) | ![](/images/채팅방.gif) |
| :-----------------------: | :-----------------------: | :---------------------: |
|    <b>약속방 생성</b>     |   <b>약속 정보 투표</b>   |   <b>약속방 채팅</b>    |
...
| ![](/images/핑키일정생성.gif) | ![](/images/핑키일정조회.gif) |
| :---------------------------: | :---------------------------: |
|     <b>챗봇 일정 생성</b>     |     <b>챗봇 일정 조회</b>     |
...
| ![](/images/약속종료.gif) | ![](/images/추억탭.gif) |
| :-----------------------: | :---------------------: |
|     <b>약속 종료</b>      |       <b>추억</b>       |
...
| ![](/images/일정생성.gif) | ![](/images/일정조회.gif) |
| :-----------------------: | :-----------------------: |
|     <b>일정 생성</b>      |     <b>일정 조회</b>      |
...
| <img src="/images/닉네임검색3.jpg" alt="" width="400" /> | <img src="/images/닉네임검색2.jpg" alt="" width="400" /> |
| :------------------------------------------------------: | :------------------------------------------------------: |
|                    <b>닉네임 검색</b>                    |                    <b>닉네임 검색</b>                    |
|   <img src="/images/팔로우.gif" alt="" width="400" />    |   <img src="/images/팔로워.jpg" alt="" width="400" />    |
|                      <b>팔로우</b>                       |                       <b>친구</b>                        |
...
| ![](/images/회원가입.gif) | ![](/images/회원탈퇴.gif) |
| :-----------------------: | :-----------------------: |
|     <b>회원 가입</b>      |     <b>회원 탈퇴</b>      |
...
| <img src="/images/알림2.jpg" alt="알림" width="400" /> |
| :----------------------------------------------------: |
|                      <b>알림</b>                       |
